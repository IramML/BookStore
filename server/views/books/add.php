              ...
              <div class="card-body">
                <form action="" method="post" class="row" enctype="multipart/form-data">
                  <div class="col-12 col-xs-12 col-md-6 form-group">
                    ...
                    <input type="text" name="title" id="i-title" class="form-control" required>
                  </div>
                  <div class="col-12 col-xs-12 col-md-6 form-group">
                    <label for="i-author"><?php echo $this->strings['author'] ?></label>
                    <input type="text" name="author" id="i-author" class="form-control" required>
                  </div>
                  <div class="col-12 col-xs-12 col-md-6 form-group">
                    <label for="i-editorial"><?php echo $this->strings['editorial'] ?></label>
                    <input type="text" name="editorial" id="i-editorial" class="form-control" required>
                  </div>
                  <div class="col-12 col-xs-12 col-md-6 form-group">
                    <label for="i-num-pages"><?php echo $this->strings['num_pages'] ?></label>
                    <input type="number" min="1" value="100" name="num_pages" id="i-num-pages" class="form-control">
                  </div>
                  <div class="col-12 col-xs-12 col-md-6 form-group">
                    <label for="i-cost"><?php echo $this->strings['cost'] ?></label>
                    <input type="number" min="1" value="100" name="cost" id="i-cost" class="form-control">
                  </div>
                  <div class="col-12 col-xs-12 col-md-6 form-group">
                    <label for="i-stock"><?php echo $this->strings['stock'] ?></label>
                    <input type="number" min="0" value="100" name="stock" id="i-stock" class="form-control">
                  </div>
                  <div class="col-12 col-xs-12 col-md-6 form-group">
                    <label for="i-description"><?php echo $this->strings['description'] ?></label>
                    <textarea name="description" id="i-description" cols="30" rows="10" class="form-control" required></textarea>
                  </div>
                  <div class="col-12 col-xs-12 col-md-6 form-group">
